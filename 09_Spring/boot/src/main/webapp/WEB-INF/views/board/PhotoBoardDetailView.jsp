...
<div class="content">
    ...
    <div class="innerOuter">
        ...
        <a class="btn btn-secondary" style="float:right;" href="list.pb">목록으로</a>
        <br><br>
                ...
                <td colspan="3">
                    <c:choose>
                        <c:when test="${not empty b.changeName }">
                            <img src="${b.changeName }" alt="첨부된 이미지" style="max-width: 100%; height: auto;">
                        </c:when>
                        <c:otherwise>
                            <!-- case2 -->
                            이미지가 없습니다.
            ...
            function postFormSubmit(type){
                ...
                switch(type){
                    case "edit" : {
                        ...
                        $(formEl).attr("action", "updateForm.pb");
                    }break;
                    case "delete":{
                        //formEl.action = "delete.bo";
                        $(formEl).attr("action", "delete.pb")
                    }break;
                }

...
// 함수의 기본 매개변수
function greet(name="방문자", msg="ㅎㅇ"){
...
// 함수의 내용에 return값만 있다면 return키워드와 {}룰 생략가능
const minus = (a, b) => a - b;
console.log("10 - 5 =", minus(10, 5));

// 전달할 매개면수가 한 개라면 ()도 생략가능
const square = x => x * x;

...
const imgUrl = "https://i.namu.wiki/i/2xZhQPaKlDgvkrL_bkhgo4UpJswzK8Y59paeOh7GO3hcKBXTKm_lkDxBcePbMAZzT6A98h6YB0CLV1tanvz6_w.webp"
...
function getImg(){
    return <img src={imgUrl} alt="로니콜먼" width={100}/>
}
...
const JavaScript = () => {
  return (
    <div>
      ...
      <ul>
        <li>
            <img src={imgUrl} alt="로니콜먼" width={100}/>
        </li>
      </ul>
      ...
      </ul> {/* 동적으로 ui 생성 시 react가 변경항목을 식별하기 위해 ket속성이 필요함 */}

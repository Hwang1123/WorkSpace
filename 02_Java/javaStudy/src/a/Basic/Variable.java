...
public class Variable {
	...
	public static void main(String[] args) {
		...
		//참과 거짓을 표현하는 자료형을 isTrue라는 이름의 변수를 만들어라.
		boolean isTrue = false;
		isTrue = true;
		System.out.println(isTrue);
		
		//실수형((소수점 6자리까지) 자료형을 지저할 수 있는 num2라는 이름의 변수를 만들어라.
		float num2;
		num2 = 3.141315816891651f;
		...
		/*
		 	...
		 	모두 정수를 저장하는 자료형, 각 자료형마다 표현할 수 있는 범위가 다르다.
		...
		/*
		 	이스케이프 시퀀스
		 	문자열 내에서 탭, 백슬러시, 작은따옴표등을 코드로 사용하기 위한 방식
		...
		*/
		...
		final int MY_AGE;
		MY_AGE = 90;
		// MY_AGE = 111; // 값을 초기화 하면 더 이상 변경할 수 없다.

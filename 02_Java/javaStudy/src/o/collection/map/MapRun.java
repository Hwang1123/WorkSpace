...
public class MapRun {
	public static void main(String[] args){
		...
		// 칼로리값 변경새도 맛만으로 동일객체로 판단하게 만들기
		
		
		System.out.println(hm);
		System.out.println(hm2);
		// 저장되는 순서 유지가 안됨 vlaue값이 중복되어도 키값이 중복되지 않으면 저장됨
		...
		//4. remove(key) : 해당 키값을 찾아서 그 밸류세트를 삭제
		hm.remove("도리토스");
		System.out.println(hm);
		...
		// 1. key를 모아서 Set자료구조의 형태로 반환 받는다.

...
<head>
	...
	<style>
        ...
        #delete-member-modal .modal-body form{
			display: flex;
			flex-direction: column;
		}
	</style>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h2 class="modal-title">탈퇴 후 복구가 불가능합니다. 정말 탈퇴하시겠습니까?</h2>
            ...
            <div class="modal-body">
              <form action="${pageContext.request.contextPath}/delete.me" method="post">
                  ...
                  <br>
                  <button id="edit-delete-btn" type="submit" class="btn btn-sm btn-danger">회원탈퇴</button>
              </form>
            </div>
          </div>
        </div>
